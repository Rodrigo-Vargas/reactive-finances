        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    port = (_a = configService.get("PORT")) !== null && _a !== void 0 ? _a : 3000;
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _b.sent();
                    common_1.Logger.log("\uD83D\uDE80 Server is up and running on port ".concat(port), "Bootstrap");
                    return [2 /*return*/];
            }
        });
    });
...
var common_1 = __webpack_require__(3);
var config_module_1 = __webpack_require__(4);
var transaction_module_1 = __webpack_require__(8);
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    ...
                    validate: function (config) { return schema_1.configSchema.parse(config); },
                }),
            ],
        })];
    var _classDescriptor;
...
var zod_1 = __webpack_require__(7);
...
var common_1 = __webpack_require__(3);
var transaction_controller_1 = __webpack_require__(9);
...
var TransactionController = function () {
    var _classDecorators = [(0, common_1.Controller)("transaction")];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _findAll_decorators;
    var TransactionController = _classThis = /** @class */ (function () {
        function TransactionController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        TransactionController_1.prototype.findAll = function () {
            var test = [];
            return test;
        };
        return TransactionController_1;
    }());
